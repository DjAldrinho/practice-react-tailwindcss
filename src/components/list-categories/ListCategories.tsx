...
export class ListCategories extends React.Component<{}, any> {
  constructor(props: any) {
    super(props);
    this.state = {
      categories: ['Naruto', 'One Piece', 'Black Clover',
  ...
  render() {
    return (
      <div
        ...
        <h2
          className="px-4 py-2 mx-2 my-2 font-sans font-bold text-gray-800 bg-gray-200 shadow-sm rounded-md">Categories</h2>
